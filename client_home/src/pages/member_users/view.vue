          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','member_name') || ($check_field('add','member_name') || $check_field('set','member_name'))" label="会员姓名" name="member_name">
                            <uni-easyinput type="text" v-model="form['member_name']" v-if="user_group === '管理员' || (form['member_users_id'] && $check_field('set','member_name')) || (!form['member_users_id'] && $check_field('add','member_name'))" :disabled="disabledObj['member_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','member_gender') || ($check_field('add','member_gender') || $check_field('set','member_gender'))" label="会员性别" name="member_gender">
                  ...
                  :clear="!disabledObj['member_gender_isDisabled']"
                  :disabled="disabledObj['member_gender_isDisabled']"
                  v-if="user_group === '管理员' || (form['member_users_id'] && $check_field('set','member_gender')) || (!form['member_users_id'] && $check_field('add','member_gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/member_users/add?",
      url_set: "~/api/member_users/set?",
      url_get_obj: "~/api/member_users/get_obj?",
