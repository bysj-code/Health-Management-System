<template>
  <view class="page_member_users diy_table diy_table_tml" id="member_users_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/member_users/view?" v-show="user_group == '管理员' || $check_action('/member_users/table','add') || $check_action('/member_users/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/member_users/table','del') || $check_action('/member_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/member_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/member_users/table','set') || $check_action('/member_users/view','set') || $check_action('/member_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                            // 会员性别列表
                list_member_gender: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
