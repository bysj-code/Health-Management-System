<template>
  <view class="page_doctor_user diy_table diy_table_tml" id="doctor_user_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/doctor_user/view?" v-show="user_group == '管理员' || $check_action('/doctor_user/table','add') || $check_action('/doctor_user/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','doctor_no')" class="col">
						<view class="view">
                            ...
                            <span>医生姓名</span>
								...
								<text>
									{{ o["doctors_name"] }}
													...
													<view v-if="1 && $check_field('get','doctors_gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>医生性别</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/doctor_user/table','del') || $check_action('/doctor_user/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/doctor_user/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/doctor_user/table','set') || $check_action('/doctor_user/view','set') || $check_action('/doctor_user/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                    // 医生性别列表
                list_doctors_gender: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
