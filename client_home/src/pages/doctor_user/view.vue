          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','doctor_no') || ($check_field('add','doctor_no') || $check_field('set','doctor_no'))" label="医生编号" name="doctor_no">
                            <uni-easyinput type="text" v-model="form['doctor_no']" v-if="user_group === '管理员' || (form['doctor_user_id'] && $check_field('set','doctor_no')) || (!form['doctor_user_id'] && $check_field('add','doctor_no'))" :disabled="disabledObj['doctor_no_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','doctors_name') || ($check_field('add','doctors_name') || $check_field('set','doctors_name'))" label="医生姓名" name="doctors_name">
                            <uni-easyinput type="text" v-model="form['doctors_name']" v-if="user_group === '管理员' || (form['doctor_user_id'] && $check_field('set','doctors_name')) || (!form['doctor_user_id'] && $check_field('add','doctors_name'))" :disabled="disabledObj['doctors_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','doctors_gender') || ($check_field('add','doctors_gender') || $check_field('set','doctors_gender'))" label="医生性别" name="doctors_gender">
                  ...
                  :clear="!disabledObj['doctors_gender_isDisabled']"
                  :disabled="disabledObj['doctors_gender_isDisabled']"
                  v-if="user_group === '管理员' || (form['doctor_user_id'] && $check_field('set','doctors_gender')) || (!form['doctor_user_id'] && $check_field('add','doctors_gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/doctor_user/add?",
      url_set: "~/api/doctor_user/set?",
      url_get_obj: "~/api/doctor_user/get_obj?",
