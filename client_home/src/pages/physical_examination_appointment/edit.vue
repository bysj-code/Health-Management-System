<template>
	<view class="diy_edit page_physical_examination_appointment" id="physical_examination_appointment_edit">
		<view class='warp'>
			<view class='container'>
				<view class='row'>
						...
						<view class="diy_field diy_datetime diy_text_row">
							...
							<view v-if="$check_field('set','contact_information') || $check_field('add','contact_information') || $check_field('get','contact_information')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								联系方式:
							</text>
							...
							<text v-else-if="$check_field('get','contact_information')">{{ form['contact_information'] }}</text>
						</view>
										</view>
...
export default {
	...
	data(){
		return{
			...
			table_key:"physical_examination_appointment",
			...
			uni.chooseImage({
				...
				success: function(res) {
					...
					const uploadTask = uni.uploadFile({
						...
						name: 'file',
						formData: {
							'physical_examination_appointment': 'test'
						},
						header: {
							'x-auth-token': _self.$store.state.user.token
						},
